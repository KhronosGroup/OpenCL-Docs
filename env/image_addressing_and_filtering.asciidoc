...
For images created with any of the following image channel data types, image read
instructions will convert the channel values from an unsigned integer to
normalized half precision floating-point values in the range [0.0h ... 1.0h].
...
For images created with any of the following image channel data types, image read
instructions will convert the channel values from a signed integer to normalized
half precision floating-point values in the range [-1.0h ... 1.0h].
...
ifdef::cl_ext_image_unsigned_10x6_12x4_14x2[]
* {CL_UNORM_INT10X6_EXT} (10-bit unsigned integer) -> `half`
+
[latexmath]
++++
normalized\_half\_value(x)=round\_to\_half(\frac{x}{1023})
...
* {CL_UNORM_INT12X4_EXT} (12-bit unsigned integer) -> `half`
+
[latexmath]
++++
normalized\_half\_value(x)=round\_to\_half(\frac{x}{4095})
++++

* {CL_UNORM_INT14X2_EXT} (14-bit unsigned integer) -> `half`
+
[latexmath]
++++
normalized\_half\_value(x)=round\_to\_half(\frac{x}{16383})
++++
endif::cl_ext_image_unsigned_10x6_12x4_14x2[]
...
ifdef::cl_ext_image_unsigned_10x6_12x4_14x2[]
For {CL_UNORM_INT10X6_EXT}:

  * 0 must convert to 0.0h, and
  * 1023 must convert to 1.0h

For {CL_UNORM_INT12X4_EXT}:

  * 0 must convert to 0.0h, and
  * 4095 must convert to 1.0h

For {CL_UNORM_INT14X2_EXT}:

  * 0 must convert to 0.0h, and
  * 16383 must convert to 1.0h
endif::cl_ext_image_unsigned_10x6_12x4_14x2[]
...
For images created with any of the following image channel data types, image
write instructions will convert the half precision floating-point color value to
an unsigned integer.
...
For images created with any of the follozing image channel data types, image
write instructions will convert the half precision floating-point color value to
a signed integer.
...
ifdef::cl_ext_image_unsigned_10x6_12x4_14x2[]
  * `half` -> {CL_UNORM_INT10X6_EXT} (10-bit unsigned integer)
+
[latexmath]
++++
\begin{aligned}
...
& f_{preferred}(x) =
\begin{cases}
 round\_to\_nearest\_even\_uint10(f(x)) & x \neq \infty \text{ and } x \neq NaN\\
 \text{implementation-defined} & x = \infty \text{ or } x = NaN
\end{cases}\\
& f_{approx}(x) =
\begin{cases}
 round\_to\_impl\_uint10(f(x)) & x \neq \infty \text{ and } x \neq NaN\\
 \text{implementation-defined} & x = \infty \text{ or } x = NaN
\end{cases}\\
\\
& |f(x) - f_{approx}(x)|\leq 0.6, x \neq \infty \text{ and } x \neq NaN
...
++++
  ...
  * `half` -> {CL_UNORM_INT12X4_EXT} (12-bit unsigned integer)
+
[latexmath]
++++
\begin{aligned}
& f(x)=max(0,min(4095,4095 \times x))\\
\\
& f_{preferred}(x) =
\begin{cases}
 round\_to\_nearest\_even\_uint12(f(x)) & x \neq \infty \text{ and } x \neq NaN\\
 \text{implementation-defined} & x = \infty \text{ or } x = NaN
\end{cases}\\
& f_{approx}(x) =
\begin{cases}
 round\_to\_impl\_uint12(f(x)) & x \neq \infty \text{ and } x \neq NaN\\
 \text{implementation-defined} & x = \infty \text{ or } x = NaN
\end{cases}\\
\\
& |f(x) - f_{approx}(x)|\leq 0.6, x \neq \infty \text{ and } x \neq NaN
...
++++
  ...
  * `half` -> {CL_UNORM_INT14X2_EXT} (14-bit unsigned integer)
+
[latexmath]
++++
\begin{aligned}
& f(x)=max(0,min(16383,16383 \times x))\\
\\
& f_{preferred}(x) =
\begin{cases}
 round\_to\_nearest\_even\_uint14(f(x)) & x \neq \infty \text{ and } x \neq NaN\\
 \text{implementation-defined} & x = \infty \text{ or } x = NaN
\end{cases}\\
& f_{approx}(x) =
\begin{cases}
 round\_to\_impl\_uint14(f(x)) & x \neq \infty \text{ and } x \neq NaN\\
 \text{implementation-defined} & x = \infty \text{ or } x = NaN
\end{cases}\\
\\
& |f(x) - f_{approx}(x)|\leq 0.6, x \neq \infty \text{ and } x \neq NaN
...
For images created with any of the following image channel data types, image read
instructions will convert the channel values from an unsigned integer to
normalized floating-point values in the range [0.0f ... 1.0f].
...
For images created with any of the following image channel data types, image read
instructions will convert the channel values from a signed integer to normalized
floating-point values in the range [-1.0f ... 1.0f].
...
ifdef::cl_ext_image_unsigned_10x6_12x4_14x2[]
* {CL_UNORM_INT10X6_EXT} (10-bit unsigned integer) -> `float`
+
[latexmath]
++++
normalized\_float\_value(x)=round\_to\_float(\frac{x}{1023})
...
* {CL_UNORM_INT12X4_EXT} (12-bit unsigned integer) -> `float`
+
[latexmath]
++++
normalized\_float\_value(x)=round\_to\_float(\frac{x}{4095})
++++

* {CL_UNORM_INT14X2_EXT} (14-bit unsigned integer) -> `float`
+
[latexmath]
++++
normalized\_float\_value(x)=round\_to\_float(\frac{x}{16383})
++++
endif::cl_ext_image_unsigned_10x6_12x4_14x2[]
...
For {CL_UNORM_INT12X4_EXT}:
  ...
  * 0 must convert to 0.0f, and
  * 4095 must convert to 1.0f

For {CL_UNORM_INT14X2_EXT}:

  * 0 must convert to 0.0f, and
  * 16383 must convert to 1.0f
endif::cl_ext_image_unsigned_10x6_12x4_14x2[]
...
For images created with any of the following image channel data types, image
write instructions will convert the floating-point color value to an unsigned
integer.
...
For images created with any of the following image channel data types, image
write instructions will convert the floating-point color value to a signed
integer.
...
ifdef::cl_ext_image_unsigned_10x6_12x4_14x2[]
  * `float` -> {CL_UNORM_INT10X6_EXT} (10-bit unsigned integer)
+
[latexmath]
++++
\begin{aligned}
...
++++
  ...
  * `float` -> {CL_UNORM_INT12X4_EXT} (12-bit unsigned integer)
+
[latexmath]
++++
\begin{aligned}
...
++++
  ...
  * `float` -> {CL_UNORM_INT14X2_EXT} (14-bit unsigned integer)
+
[latexmath]
++++
\begin{aligned}
...
[[conversion-rules-for-signed-and-unsigned-integer-channel-data-types]]
==== Conversion Rules for Signed and Unsigned Integer Channel Data Types

For images created with any of the following image channel data types, image
read instructions will return the integer values stored in the
image at specified location, after sign extension to 32 bits for integer
...
Likewise, for images created with any of the following image channel data types,
image read instructions will return the integer values stored in the image at
specified location, after zero extension to 32 bits for integer values smaller
than 32 bits.
...
ifdef::cl_ext_image_unsigned_10x6_12x4_14x2[]
* 32 bit unsigned integer -> {CL_UNSIGNED_INT10X6_EXT} (10-bit unsigned integer):
+
[latexmath]
++++
uint10\_value(x) = clamp(x, 0, 1023)
++++

* 32 bit unsigned integer -> {CL_UNSIGNED_INT12X4_EXT} (12-bit unsigned integer):
+
[latexmath]
++++
uint12\_value(x) = clamp(x, 0, 4095)
++++

* 32 bit unsigned integer -> {CL_UNSIGNED_INT14X2_EXT} (14-bit unsigned integer):
+
[latexmath]
++++
uint14\_value(x) = clamp(x, 0, 16383)
++++
endif::cl_ext_image_unsigned_10x6_12x4_14x2[]
