// Copyright 2018-2019 The Khronos Group. This work is licensed under a
...
Copyright (c) 2019 Some Company. Copyright terms at: +
...
. Calling *clShinyNewFunction* twice with incompatible flags must fail
 - Call *clShinyNewFunction* with +CL_NEW_FLAG+ set, it must succeed
 - Call *clShinyNewFunction* again with +CL_NEW_INCOMPATIBLE_FLAG+ set, it must
   fail
...
| 4   | 2019-10-25 | Kévin Petit  | Added conformance tests section.
|====
