...
* A `size` equal to zero is undefined behavior.
...
* A `ptr` equal to `NULL` is undefined behavior.  This appears to be the specified behavior for the C `memcpy` and `memset` functions.
