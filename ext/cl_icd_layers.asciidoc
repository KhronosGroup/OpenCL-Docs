...
[[cl_icd_layers-opencl]]
== Installable OpenCL Loader Layers

[[cl_icd_layers-overview]]
=== Overview

This section describes *cl_icd_layers* loader extension which defines
...
[[cl_icd_layers-new-procedures-and-functions]]
...
[[cl_icd_layers-new-environment-variables]]
