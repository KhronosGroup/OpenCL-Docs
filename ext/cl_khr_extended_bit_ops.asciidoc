...
//=== Issues
//
//. What should we call these functions, especially the `bitfield_extract` functions?
//+
//--
//*RESOLVED*: The functions are called `bitfield_extract_signed` and `bitfield_extract_unsigned`.
//
//Other options:
//
//* `bitfield_extracti` and `bitfield_extract_ui`.
//* Just `bitfield_extract` and sign extend or zero extend depending on the type of the arguments.
//--
//
//. What types are supported for for the SPIR-V bit instructions?
//+
//--
//*UNRESOLVED*: Propose to support just the 32-bit integer types, matching the OpenCL C built-in functions.
//--
