...
[source,c]
----
#define CL_LAYER_API_VERSION        0xDEADBEEF
----
...
The header file *include/cl_icd_layer.h* defines the necessary types
and API entry points.

The official API headers are available on github, at:

https://github.com/KhronosGroup/OpenCL-Headers
The header file *cl_icd.h* defines the OpenCL dispatch table.
