...
Changes from *v3.1.0* to *v3.1.1*:
  ...
  * Clarified the description of the `any` and `all` functions, see {khronos-opencl-pr}/1561[#1561].
  * {cl_khr_fp16_EXT}
...
Changes from *v3.1.1* to *v3.1.2*:
  ...
  * Fixed the `CL_VERSION_3_1` integer representation, see {khronos-opencl-pr}/1568[#1568].
  * Added an informative footnote about backslash characters in file names, see {khronos-opencl-pr}/1600[#1600].
