...
include::{generated}/api/version-notes/CL_DEVICE_SPIRV_EXTENDED_INSTRUCTION_SETS_KHR.asciidoc[]
  | {char_TYPE}*[]
      | Returns an array of null-terminated strings, where each string describes
        ...
        For each of the strings in the returned array, it is valid to import the
        SPIR-V extended instruction set in a SPIR-V module using the SPIR-V
        instruction *OpExtInstImport*.
...
include::{generated}/api/version-notes/CL_DEVICE_SPIRV_EXTENSIONS_KHR.asciidoc[]
  | {char_TYPE}*[]
      | Returns an array of null-terminated strings, where each string describes
        ...
        For each of the strings in the returned array, it is valid to declare
        use of the SPIR-V extension in a SPIR-V module using the SPIR-V
...
include::{generated}/api/version-notes/CL_DEVICE_SPIRV_CAPABILITIES_KHR.asciidoc[]
  | {cl_uint_TYPE}[]
      | Returns an array of SPIR-V token values, where each value describes a
        ...
        For each of the values in the returned array, it is valid to declare
        use of the SPIR-V capability in a SPIR-V module using the SPIR-V
        instruction *OpCapability*.
