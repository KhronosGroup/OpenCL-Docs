...
Behavior is undefined if this value for *memory_scope* is used with an atomic function other than *atomic_work_item_fence* or with memory flags other than `CLK_IMAGE_MEM_FENCE`. \
]
