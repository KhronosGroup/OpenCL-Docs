...
=== New Commands
  ...
  * {clEnqueueSVMMemcpyWithPropertiesKHR}[[clEnqueueSVMMemcpyWithPropertiesKHR]]
...
=== Version History
  ...
  * Revision 0.9.1, 2026-07-27
  ** Added {clEnqueueSVMMemcpyWithPropertiesKHR} (experimental).
