...
publicly available to enable review and feedback from the community. In
constrast to <<boilerplate-provisional-header,provisional extensions>>,
experimental extensions are not ratified under the Khronos Intellectual
Property Framework.
While an extension is experimental, features may be added, removed, or
changed in non-backward compatible ways.
