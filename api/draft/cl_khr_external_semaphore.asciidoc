//@ TODO Must be split now
// Copyright 2021-2023 The Khronos Group.
...
Other related extensions define specific external semaphores that may be
imported into or exported from OpenCL.
...
Added by `cl_khr_external_semaphore_dx_fence`:
  * {cl_external_semaphore_handle_type_khr_TYPE}
  ** {CL_SEMAPHORE_HANDLE_D3D12_FENCE_KHR}

Added by `cl_khr_external_semaphore_opaque_fd`:
  * {cl_external_semaphore_handle_type_khr_TYPE}
  ** {CL_SEMAPHORE_HANDLE_OPAQUE_FD_KHR}

Added by `cl_khr_external_semaphore_sync_fd`:
  * {cl_external_semaphore_handle_type_khr_TYPE}
  ** {CL_SEMAPHORE_HANDLE_SYNC_FD_KHR}

Added by `cl_khr_external_semaphore_win32`:
  * {cl_external_semaphore_handle_type_khr_TYPE}
