...
--
To read from a buffer object to host memory, call one of the functions
...
OpenCL 2.0 added support for shared virtual memory (a.k.a.
SVM).
...
barrier ({clEnqueueBarrierWithWaitList}) command can be enqueued to the
command-queue.
