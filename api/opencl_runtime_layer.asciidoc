...
include::{generated}/api/version-notes/clBuildProgram.asciidoc[]
  ...
  * _pfn_notify_ is a function pointer to a notification routine.
    ...
    can begin.
    The application can query the program\'s build status and log from this
    callback function to determine if the build was successful.
...
include::{generated}/api/version-notes/clCompileProgram.asciidoc[]
  ...
  * _pfn_notify_ is a function pointer to a notification routine.
    ...
    begin.
    The application can query the program\'s compile status and log from this
    callback function to determine if the build was successful.
...
The application can query the link status and log for this program object from
this callback function to determine if the build was successful.
This callback function may be called asynchronously by the OpenCL
implementation.
It is the applications responsibility to ensure that the callback function
is thread-safe.
