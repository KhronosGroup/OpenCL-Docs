...
{cl_khr_external_semaphore_sync_fd_EXT}, {cl_khr_external_semaphore_dx_fence_EXT},
and {cl_khr_external_semaphore_win32_EXT} define specific external semaphores
